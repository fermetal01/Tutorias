...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, co.edu.ucentral.tutorias.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, co.edu.ucentral.tutorias.repository.UserRepository.USERS_BY_EMAIL_CACHE);
